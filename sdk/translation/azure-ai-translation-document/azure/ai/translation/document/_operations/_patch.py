...
from ._operations import (
    DocumentTranslationClientOperationsMixin as GeneratedDTClientOps,
    JSON,
    ClsType,
)


class DocumentTranslationClientOperationsMixin(GeneratedDTClientOps):  # pylint: disable=name-too-long
    @overload
    def begin_start_translation(
        self, body: _models.StartTranslationDetails, *, content_type: str = "application/json", **kwargs: Any
    ) -> Tuple[LROPoller[None], str]:
    ...
    def begin_start_translation(
        ...
        # get translation_id
        response_content = raw_result.http_response.read()
        ...
        return LROPoller[None](self._client, raw_result, get_long_running_output, polling_method), translation_id  # type: ignore
