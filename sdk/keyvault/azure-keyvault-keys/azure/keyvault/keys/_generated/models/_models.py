...
class JsonWebKey(_model_base.Model):  # pylint: disable=too-many-instance-attributes
...
class KeyAttributes(_model_base.Model):
    ...
    :ivar recovery_level: Reflects the deletion recovery level currently in effect for keys in the
     ...
     the retention interval. Known values are: "Purgeable", "Recoverable+Purgeable", "Recoverable",
    ...
    """Reflects the deletion recovery level currently in effect for keys in the
     current vault. If it contains 'Purgeable' the key can be permanently deleted by
     a privileged user; otherwise, only the system can purge the key, at the end of
     the retention interval. Known values are: \"Purgeable\", \"Recoverable+Purgeable\",
...
class KeyOperationsParameters(_model_base.Model):
    ...
    :ivar iv: Cryptographically random, non-repeating initialization vector for symmetric
     algorithms.
    :vartype iv: bytes
    :ivar aad: Additional data to authenticate but not encrypt/decrypt when using
     authenticated crypto algorithms.
    :vartype aad: bytes
    :ivar tag: The tag to authenticate when performing decryption with an authenticated
     algorithm.
    :vartype tag: bytes
    """
...
class KeyVerifyParameters(_model_base.Model):
    ...
    :ivar algorithm: The signing/verification algorithm. For more information on possible algorithm
     ...
     "PS512", "RS256", "RS384", "RS512", "RSNULL", "ES256", "ES384", "ES512", and "ES256K".
    :vartype algorithm: str or ~azure.keyvault.keys.models.JsonWebKeySignatureAlgorithm
...
class LifetimeActionsType(_model_base.Model):
    ...
    :vartype type: str or ~azure.keyvault.keys.models.ActionType
    """

    type: Optional[Union[str, "_models.ActionType"]] = rest_field()
    ...
    def __init__(
        self,
        *,
        type: Optional[Union[str, "_models.ActionType"]] = None,
    ): ...
